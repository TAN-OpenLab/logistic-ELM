function [TrainingAccuracy, TestingAccuracy] = MainLogisticELM(TrainingData_File,DevelopmentData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction,mu,z1)
...
Position = FeatureSelection(TrainingData_File,DevelopmentData_File,mu,z1) ;
...
[~, ~, TrainingAccuracy, TestingAccuracy] = Logistic_ELM(Train, Test, Elm_Type, NumberofHiddenNeurons, ActivationFunction, W);
end